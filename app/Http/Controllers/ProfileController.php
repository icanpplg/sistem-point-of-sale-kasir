...
class ProfileController extends Controller
{
    ...
    /**
     * Update data user di tabel "users" (misalnya username, email, password, dsb.).
     */
    public function update(ProfileUpdateRequest $request): RedirectResponse|JsonResponse
    {
        ...
        // Update data user (username, email, password, dll.)
        $user->update($data);

        if ($request->ajax() || $request->wantsJson()) {
            return response()->json([
                'message' => 'username Password email (akun) berhasil diperbarui.',
